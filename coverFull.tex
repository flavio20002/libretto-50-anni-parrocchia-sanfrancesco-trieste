...
\usepackage[margin=19mm,paperwidth=304mm,paperheight=210mm]{geometry}
...
\node[minimum width=\lunghezzapagina,inner sep=0pt,anchor=east, outer sep=0pt, fill opacity=1.0, align=center] at (current page.east) {\includegraphics[width=\lunghezzapagina,height=\paperheight]{chiesa.jpg}};
