...
\centering
\includegraphics[width=0.29\textwidth]{immagini/lorenzo.jpg}
\end{wrapfigure}
...
\centering
\includegraphics[width=0.3\textwidth]{immagini/tiberio.jpg}
\end{wrapfigure}
...
\hfill\textit{Maria Grazia Berti}
\begin{center}
	\noindent\rule{0.5\textwidth}{0.4pt}
\end{center}
...
con p. Lorenzo: dal gennaio ‘93 venne avviato il Giornalino Parrocchiale “Due o più” con uscita 
