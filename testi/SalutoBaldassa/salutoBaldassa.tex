\documentclass[12pt,openright,twoside]{letter}
...
\date{3 ottobre 1976}
\address{\textbf{Saluto alla parrocchia}}
\begin{document}
\pagenumbering{gobble}
\begin{letter}{}
\opening{Miei Fratelli,}
...
\closing{\hspace*{-1.3cm}\fromsig{\includegraphics[scale=0.16]{firma.jpg}} \\
\hspace*{-1.3cm}\fromname{Padre Olindo Maria Baldassa}
}
\end{letter}
\end{document}