...
\node[text width = \larghezzalaterale,anchor=south, minimum width=\larghezzalaterale, minimum height=\paperheight, inner sep=0pt, outer sep=0pt, fill=red, fill opacity=1, text opacity=1, align=center] at (current page.south) {%
};
