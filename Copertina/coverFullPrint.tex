...
\usepackage[margin=19mm,paperwidth=311.486mm,paperheight=220mm]{geometry} %314=148.5 + 148.5 + 4.486 + 10 di abbondanza %220=210 + 10 di abbondanza
...
\def\larghezzalaterale{4.486mm}
\def\larghezzalateralediv{2.243mm}
...
\draw[white, very thick] ($(current page.north west)+(0mm,-5mm)$) -- ++(3mm,0mm); %o
\draw[white, very thick] ($(current page.north west)+(\paperwidth,-5mm)$) -- ++(-3mm,0mm); %o
\draw[white, very thick] ($(current page.south west)+(0mm,5mm)$) -- ++(3mm,0mm); %u
\draw[white, very thick] ($(current page.south west)+(\paperwidth,5mm)$) -- ++(-3mm,0mm); %u
\draw[white, very thick] ($(current page.north east)+(-5mm,0mm)$) -- ++(0,-3mm); %r
\draw[white, very thick] ($(current page.north east)+(-5mm,-\paperheight)$) -- ++(0,3mm); %r
\draw[white, very thick] ($(current page.north west)+(5mm,0mm)$) -- ++(0,-3mm); %l
\draw[white, very thick] ($(current page.north west)+(5mm,-\paperheight)$) -- ++(0,3mm); %l
\draw[white, very thick] ($(current page.north)+(-\larghezzalateralediv,0mm)$) -- ++(0,-3mm); %m
\draw[white, very thick] ($(current page.north)+(+\larghezzalateralediv,0mm)$) -- ++(0,-3mm); %m
\draw[white, very thick] ($(current page.south)+(-\larghezzalateralediv,0mm)$) -- ++(0,+3mm); %m
\draw[white, very thick] ($(current page.south)+(+\larghezzalateralediv,0mm)$) -- ++(0,+3mm); %m
\end{tikzpicture}
